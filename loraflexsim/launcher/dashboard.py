...
from launcher import adr_standard_1, adr_2, adr_3, explora_at  # noqa: E402
...
explora_button = pn.widgets.Button(name="explora_at")
...
def select_adr(module, name: str) -> None:
    ...
    for btn in (adr1_button, adr2_button, adr3_button, explora_button):
    ...
    if name == "ADR 1":
        ...
        explora_button.button_type = "primary"
    if sim is not None:
...
explora_button.on_click(lambda event: select_adr(explora_at, "Explora-AT"))
...
controls = pn.WidgetBox(
    ...
    adr_node_checkbox,
    adr_server_checkbox,
    pn.Row(adr1_button, adr2_button, adr3_button, explora_button, adr_active_badge),
    fixed_sf_checkbox,
    sf_value_input,
